...
import { IMyvariables, IPropsBoardWrite } from "./BoarsWrit.types";

export default function BoardWrite(props: IPropsBoardWrite) {
  // props는 함수의 타입의미! 컨테이너에서 함수에 props라는 매개변수로 넘겨주는것이니 타입지정필요!// 함수는 어디에서든 호출이 가능하기에 타입명시해줘야함.
  ...
  const onClickSubmit = async () => {
    ...
    ); // 해당 게시물 번호를 가지고 올 수 있음. ==> 등록하면 상세페이지로 이동.
  };
